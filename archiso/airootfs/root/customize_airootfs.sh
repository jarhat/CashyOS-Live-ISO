...
# Disable service when available
{ [[ -e /usr/lib/systemd/system/sshd.service            ]] && systemctl mask sshd.service;
} > /dev/null 2>&1
...
echo 'lair' > /etc/hostname

# Set wallpaper globally
rm /usr/share/backgrounds/xfce/xfce-x.svg
ln -s /home/liveuser/.local/share/wallpapers/wallpaper.png /usr/share/backgrounds/xfce/xfce-x.svg
